...
<body>
  ...
  <div id="disqualification-container" class="hidden">
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const disqualificationContainer = document.getElementById("disqualification-container");
    const retryButton = document.getElementById("retry-button");

    // دالة لإظهار رسالة الإقصاء
    function showDisqualification() {
        welcomeSection.classList.add("hidden"); // إخفاء قسم الترحيب
        examSection.classList.add("hidden"); // إخفاء قسم الامتحان
        disqualificationContainer.classList.remove("hidden"); // إظهار رسالة الإقصاء
    }

    // دالة لإخفاء رسالة الإقصاء
    function hideDisqualification() {
        disqualificationContainer.classList.add("hidden");
    }
    ...
    window.addEventListener("beforeunload", function (event) {
        ...
        if (examSection.classList.contains("hidden") === false && document.getElementById("result").classList.contains("hidden")) {
             localStorage.setItem("disqualified", "true");
        }
        // لا يمكن تخصيص الرسالة في معظم المتصفحات الحديثة لأسباب أمنية.
        // event.returnValue = "هل أنت متأكد أنك تريد المغادرة؟ قد تفقد تقدمك في الامتحان.";
    });

    // معالج الحدث لزر إعادة المحاولة
    retryButton.addEventListener("click", () => {
        localStorage.removeItem("disqualified"); // مسح حالة الإقصاء
        location.reload(); // إعادة تحميل الصفحة لبدء محاولة جديدة
    });
    ...
    window.startExam = function() {
        hideDisqualification(); // التأكد من إخفاء رسالة الإقصاء
    ...
    // أسئلتك هنا (انسخها والصقها من الكود الأصلي)
